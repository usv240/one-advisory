...
app.include_router(build_router(incident_store,allow_global_reset=ALLOW_GLOBAL_RESET)); app.include_router(build_pilot_router(incident_store)); app.include_router(build_hardening_router(incident_store,wake_scheduler,clock))
