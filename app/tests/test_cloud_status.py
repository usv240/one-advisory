...
def test_health_exposes_truthful_google_service_inventory():
    ...
    expected = {"Gemini 3.5 Flash on Vertex AI", "Google Gen AI SDK", "Cloud Run", "Firestore", "Cloud Scheduler", "Cloud Trace", "Agent Registry", "Agent Runtime", "Agent Identity", "Agent Gateway", "Model Armor"}
...
def test_header_has_accessible_live_stack_control():
    ...
    assert 'data-platform-endpoint="/api/platform"' in html
